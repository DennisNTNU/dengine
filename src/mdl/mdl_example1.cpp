...
Mdl_example1::Mdl_example1(GLuint shaderID, GLuint textureID)
...
void Mdl_example1::initData(unsigned int** indices, float** vertexPositions, float** vertexUVs, int* vertexCount)
{
    *vertexCount = 6;
    int triangleCount = 2;
